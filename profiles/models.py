...
class Profile(models.Model):
    ...
    theme_background_color = models.CharField('ЦВЕТ ФОНА (СТРАНИЦЫ)', max_length=7, default='#FFFFFF', help_text='Цвет общего фона страницы (за кнопками)')
    theme_line_color = models.CharField('ЦВЕТ ЛИНИЙ/ГРАНИЦ', max_length=7, default='#E6E6E6', help_text='Цвет линий разделителей и границ')
    theme_page_background_color = models.CharField('ВНЕШНИЙ ФОН СТРАНИЦЫ', max_length=7, default='#FFFFFF', help_text='Фон за шапкой и контентом всей страницы')
